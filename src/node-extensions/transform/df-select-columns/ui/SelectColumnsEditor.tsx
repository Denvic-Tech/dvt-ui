...
import { getTypeIcon, toAvailableColumns, toSelectedColumns } from './helpers';
import {
  ActionButton,
  ActionsRow,
  AddButton,
...
export const SelectColumnsEditor: React.FC<
  NodeModalExtensionProps<SelectColumnsValues>
> = ({
  id: nodeID,
  nodeDefinition,
  localInputData,
